...
public class SpellcastingTemplate extends InnateSpellcastingTemplate {
	...
	public SpellcastingTemplate() {
		...
		fields.set(8, new TemplateField("spells", FieldType.MAP, FieldType.STRING, "Level", FieldType.LIST, FieldType.STRING, "Spells", true));
